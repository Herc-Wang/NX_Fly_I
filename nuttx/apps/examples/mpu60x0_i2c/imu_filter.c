...
{
	static float buf[Filter_Arr_N] = {0.0};
...
{
	static float bufx[Filter_Arr_N],bufy[Filter_Arr_N],bufz[Filter_Arr_N];
	static uint8_t cnt =0,flag = 1;
...
{
  static float bufax[Filter_Arr_N],bufay[Filter_Arr_N],bufaz[Filter_Arr_N],bufgx[Filter_Arr_N],bufgy[Filter_Arr_N],bufgz[Filter_Arr_N];
	static uint8_t cnt =0,flag = 1;
...
{
  static int32_t bufax[Filter_Arr_N],bufay[Filter_Arr_N],bufaz[Filter_Arr_N];
	static uint8_t cnt =0,flag = 1;
