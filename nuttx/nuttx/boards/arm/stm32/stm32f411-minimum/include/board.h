...
#define STM32_PLLCFG_PLLM       RCC_PLLCFG_PLLM(8)      //herc change
...
#define GPIO_I2C1_SCL_GPIO \
   (GPIO_OUTPUT|GPIO_FLOAT|GPIO_OPENDRAIN|GPIO_SPEED_50MHz|GPIO_OUTPUT_SET|GPIO_PORTB|GPIO_PIN6)
#define GPIO_I2C1_SDA_GPIO \
   (GPIO_OUTPUT|GPIO_FLOAT|GPIO_OPENDRAIN|GPIO_SPEED_50MHz|GPIO_OUTPUT_SET|GPIO_PORTB|GPIO_PIN7)
